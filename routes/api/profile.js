...
// @access Private
router.post('/experience', ensureLoggedIn('/login'), (req, res) => {
...
// @access Private
router.post('/education', ensureLoggedIn('/login'), (req, res) => {
...
// @access Private
router.delete('/experience/:exp_id', ensureLoggedIn('/login'), (req, res) => {
  Profile.findOne({ user: req.user.id })
    .then(profile => {
      // Get remove index
      ...
      if (removeIndex === -1) {
        return res.status(404).json({
          error: 'Experience does not exists',
        });
      }
...
// @access Private
router.delete('/education/:edu_id', ensureLoggedIn('/login'), (req, res) => {
  Profile.findOne({ user: req.user.id })
    .then(profile => {
      // Get remove index
      ...
      if (removeIndex === -1) {
        return res.status(404).json({
          error: 'Education does not exists',
        });
      }
...
// @access Private
router.delete('/', ensureLoggedIn('/login'), (req, res) => {
