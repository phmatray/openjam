...
// Selectors
//
export const getOriginalTracks = state => state.ui.views.explore.originalTracks;
export const getOriginalTracksLoading = state => state.ui.views.explore.originalTracksLoading;
export const getOriginalTracksError = state => state.ui.views.explore.originalTracksError;
export const getRemixTracks = state => state.ui.views.explore.remixTracks;
export const getRemixTracksLoading = state => state.ui.views.explore.remixTracksLoading;
export const getRemixTracksError = state => state.ui.views.explore.remixTracksError;
export const getArtists = state => state.ui.views.explore.artists;
export const getArtistsLoading = state => state.ui.views.explore.artistsLoading;
export const getArtistsError = state => state.ui.views.explore.artistsError;
