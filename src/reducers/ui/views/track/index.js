...
// Selectors
//
export const getTrack = state => state.ui.views.track.track;
export const getTrackLoading = state => state.ui.views.track.trackLoading;
export const getTrackError = state => state.ui.views.track.trackError;
export const getByArtist = state => state.ui.views.track.byArtist;
export const getByArtistLoading = state => state.ui.views.track.byArtistLoading;
export const getByArtistError = state => state.ui.views.track.byArtistError;
