...
import { actions as errorActions } from 'store/modules/data/error';
import {
  restGetPosts,
  restGetPost,
  restDeletePost,
...
// Selectors
//
export const getPosts = state => state.ui.views.share.posts;
export const getPost = state => state.ui.views.share.post;
export const getLoading = state => state.ui.views.share.loading;
