...
import { deleteAccount } from 'store/modules/data/profile';
import { fetchMe, getUser, getLoading } from 'store/modules/ui/views/dashboard';
import type { UserBasic } from 'lib/types';

import PaneAccount from './children/PaneAccount';
import PaneProfile from './children/PaneProfile';
import PaneMarketplace from './children/PaneMarketplace';
