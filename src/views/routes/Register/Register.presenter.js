...
class RegisterPresenter extends PureComponent<Props, State> {
  state = {
    firstName: '',
    lastName: '',
    email: '',
  ...
  render() {
    const { firstName, lastName, email, password, password2, pin } = this.state;
    const { errors, theme, t } = this.props;
...
export default withTheme(withNamespaces('common')(RegisterPresenter));
