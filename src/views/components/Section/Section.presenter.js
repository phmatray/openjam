...
import ModelCollection from './children/ModelCollection';
...
const Section = ({ type, title, items, to, maxHeight, scrollable, theme, t }: Props) => (
  <Segment>
    ...
    {scrollable ? (
      <Scrollable>
        <Flex column wrapBreak contentStart style={{ maxHeight }}>
          <ModelCollection models={items} type={type} />
        </Flex>
      </Scrollable>
    ) : (
